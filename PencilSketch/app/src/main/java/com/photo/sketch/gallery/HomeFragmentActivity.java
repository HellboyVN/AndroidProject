...
public class HomeFragmentActivity extends FragmentActivity implements OnImageSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mTabHost.getTabWidget().getChildAt(1) != null) {
            ((TextView) this.mTabHost.getTabWidget().getChildAt(1).findViewById(android.R.id.title)).setTextColor(getResources().getColor(R.color.white));
        }
        this.mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
            public void onTabChanged(String tabId) {
                ...
                if (tabId.equalsIgnoreCase("tab1")) {
                    ...
                    ((TextView) HomeFragmentActivity.this.mTabHost.getTabWidget().getChildAt(0).findViewById(android.R.id.title)).setTextColor(HomeFragmentActivity.this.getResources().getColor(R.color.transparent));
                    ...
                    ((TextView) HomeFragmentActivity.this.mTabHost.getTabWidget().getChildAt(1).findViewById(android.R.id.title)).setTextColor(HomeFragmentActivity.this.getResources().getColor(R.color.transparent));
                }
    ...
    public void onImageSelected(int count) {
        if (this.mTabHost.getTabWidget().getChildAt(1) != null) {
            if (count != 0) {
                ((TextView) this.mTabHost.getTabWidget().getChildAt(1).findViewById(android.R.id.title)).setText(new StringBuilder(String.valueOf(getResources().getString(R.string.images_tab))).append("  ").append(count).toString());
            } else {
                ((TextView) this.mTabHost.getTabWidget().getChildAt(1).findViewById(android.R.id.title)).setText(getResources().getString(R.string.image));
            }
        } else if (count != 0) {
            ((TextView) this.mTabHost.getTabWidget().getChildAt(0).findViewById(android.R.id.title)).setText(new StringBuilder(String.valueOf(getResources().getString(R.string.images_tab))).append("  ").append(count).toString());
        } else {
            ((TextView) this.mTabHost.getTabWidget().getChildAt(0).findViewById(android.R.id.title)).setText(getResources().getString(R.string.image));
        }
    }
