    ...
    class Broadcast extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.intent.action.BATTERY_CHANGED")) {
                ...
                String msg_from = "";
                LockNoPasscode.this.layoutNoti.setVisibility(View.VISIBLE);
                if (bundle != null){
                    try{
                        ...
                        LockNoPasscode.this.tvNoti.setTextColor(Color.BLACK);
                        LockNoPasscode.this.tvNoti.setText(msgBody);
                        if(getContactName(msg_from,LockNoPasscode.this)!= null){
                            LockNoPasscode.this.tvMesOrCall.setText(getContactName(msg_from,LockNoPasscode.this));
                        }else {
                            LockNoPasscode.this.tvMesOrCall.setText(msg_from);
                        }
                        LockNoPasscode.this.imgNoti.setImageResource(R.drawable.icon_new_message);
                        ...
                        case 0:
                            ...
                            if (!LockNoPasscode.isfirst) {
                                ...
                                if (!LockNoPasscode.isfirst) {
                                    ...
                                    LockNoPasscode.this.checkcall = true;
                                    LockNoPasscode.this.callMissing = incomingNumber;
                                    LockNoPasscode.this.editor.putBoolean("checkcall", true);
                                    LockNoPasscode.this.editor.putString("callMissing", callMissing);
                                    LockNoPasscode.this.editor.commit();
                                    Log.e("...........PASS:  ", String.valueOf(LockNoPasscode.this.checkcall)+
                                            " "+LockNoPasscode.this.callMissing);
...
//        }
        ...
        if (this.sharedPreferences.getBoolean("checkcall", false)){
            LockNoPasscode.this.layoutNoti.setVisibility(View.VISIBLE);
            LockNoPasscode.this.tvMesOrCall.setTextColor(Color.RED);
            LockNoPasscode.this.tvMesOrCall.setText(getContactName(this.sharedPreferences.getString("callMissing", "UnKnown")
                    ,LockNoPasscode.this));
            LockNoPasscode.this.imgNoti.setImageResource(R.drawable.icon_missing_call);
            LockNoPasscode.this.tvNoti.setText(this.sharedPreferences.getString("callMissing", "UnKnown"));
            LockNoPasscode.this.editor.putBoolean("checkcall", false);
            LockNoPasscode.this.editor.commit();
        }
