...
import hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.exersices.ExerciseActivity.MoveReason;
import hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.listeners.IProgressWheel;
...
import hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.utils.SoundHelper.NumberSounds;
...
public class ExerciseView extends View {
    ...
    private IExerciseNavigation mNavigationListener;
    ...
    private void setupPaints() {
        ...
        this.titlePaint.setTextSize((float) this.textSize);
    ...
    public void setNavigationListener(IExerciseNavigation listener) {
    ...
    public void setTime(int time) {
        ...
        this.mCountdownNumberSound = NumberSounds.getCountdouwnStart(time / 1000);
    }
            ...
            this.mTimer = new CountDownTimer(this.mCurrentTime, 100) {
                ...
                public void onFinish() {
                    ...
                    if (ExerciseView.this.mRepeatCount == 0 || ExerciseView.this.mCurrentRepeat + 1 == ExerciseView.this.mRepeatCount) {
                        if (ExerciseView.this.mNavigationListener != null) {
                            ExerciseView.this.mNavigationListener.onNavigation(MoveReason.NATURAL_RIGHT);
                        }
                        if (ExerciseView.this.mListener != null) {
    ...
    public void animateProgress(ProgressBar mprogressbar) {
        mprogressbar.setMax((int)this.mTime);
        this.mProgressAnim = ObjectAnimator.ofInt(mprogressbar, NotificationCompat.CATEGORY_PROGRESS, new int[]{(int) this.mCurrentTime, 0});
        this.mProgressAnim.setDuration(this.mTime);
