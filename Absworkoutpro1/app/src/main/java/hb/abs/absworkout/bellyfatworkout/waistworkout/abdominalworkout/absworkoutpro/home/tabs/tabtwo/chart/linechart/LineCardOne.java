package hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.home.tabs.tabtwo.chart.linechart;
...
import hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.home.tabs.tabtwo.chart.CardController;

public class LineCardOne extends CardController {
    private Runnable mBaseAction;
    private final LineChartView mChart;
    private final Context mContext;
    private final String[] mLabels = new String[]{"Jan", "Fev", "Mar", "Apr", "Jun", "May", "Jul", "Aug", "Sep"};
    private Tooltip mTip;
    private final float[][] mValues = new float[][]{new float[]{3.5f, 4.7f, 4.3f, 8.0f, 6.5f, 9.9f, 7.0f, 8.3f, 7.0f}, new float[]{4.5f, 2.5f, 2.5f, 9.0f, 4.5f, 9.5f, 5.0f, 8.3f, 1.8f}};
    private final String[] mWeekLabels = new String[]{"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"};
    private final float[][] mWeekValues = new float[][]{new float[]{3.5f, 4.7f, 4.3f, 8.0f, 6.5f, 9.9f, 7.0f}, new float[]{4.5f, 2.5f, 2.5f, 9.0f, 4.5f, 9.5f, 5.0f}};
    ...
    public void show(Runnable action) {
        ...
        LineSet dataset = new LineSet(this.mWeekLabels, this.mWeekValues[0]);
        ...
        dataset = new LineSet(this.mWeekLabels, this.mWeekValues[0]);
        ...
        this.mChart.show(new Animation().setInterpolator(new BounceInterpolator()).withEndAction(new Runnable() {
            public void run() {
                ...
                LineCardOne.this.mTip.prepare((Rect) LineCardOne.this.mChart.getEntriesArea(0).get(3), LineCardOne.this.mValues[0][3]);
