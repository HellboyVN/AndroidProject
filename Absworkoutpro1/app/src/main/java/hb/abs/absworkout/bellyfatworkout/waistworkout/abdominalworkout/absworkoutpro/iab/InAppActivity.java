package hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.iab;
...
import hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.FabricLogger;
import hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.R;
import hb.abs.absworkout.bellyfatworkout.waistworkout.abdominalworkout.absworkoutpro.ads.NativeAdActivity;
...
//    public static final String SKU_PRO_PACKAGE = "android.test.purchased";
    public static final String SKU_PRO_PACKAGE = "caotramanh";
...
//    public static final String SKU_REMOVE_ADS = "android.test.purchased";
    ...
    protected void showInterFacebook(Context context){
        ...
        if(!this.mIsProPackageAvailable){
            interstitialAd = new InterstitialAd(context, "208187523282768_208187693282751");
