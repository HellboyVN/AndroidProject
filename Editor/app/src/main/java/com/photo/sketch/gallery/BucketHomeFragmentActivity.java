        ...
        this.mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
            public void onTabChanged(String tabId) {
                ...
                if (tabId.equalsIgnoreCase("tab1")) {
                    ...
                    ((TextView) BucketHomeFragmentActivity.this.mTabHost.getTabWidget().getChildAt(0).findViewById(16908310)).setTextColor(BucketHomeFragmentActivity.this.getResources().getColor(R.color.transparent));
                } else {
                    ((TextView) BucketHomeFragmentActivity.this.mTabHost.getTabWidget().getChildAt(0).findViewById(16908310)).setTextColor(-1);
                    ((TextView) BucketHomeFragmentActivity.this.mTabHost.getTabWidget().getChildAt(1).findViewById(16908310)).setTextColor(BucketHomeFragmentActivity.this.getResources().getColor(R.color.transparent));
                }
