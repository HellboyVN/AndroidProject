package hb.legsandbuttocksworkout.homeworkout.gym.buttlegs.buttlegspro.buttlegschallenge.iab;
...
import hb.legsandbuttocksworkout.homeworkout.gym.buttlegs.buttlegspro.buttlegschallenge.FabricLogger;
import hb.legsandbuttocksworkout.homeworkout.gym.buttlegs.buttlegspro.buttlegschallenge.R;
import hb.legsandbuttocksworkout.homeworkout.gym.buttlegs.buttlegspro.buttlegschallenge.ads.NativeAdActivity;
...
//    public static final String SKU_REMOVE_ADS = "android.test.purchased";
    ...
    protected void showInterFacebook(Context context){
        ...
        if(!this.mIsProPackageAvailable){
            interstitialAd = new InterstitialAd(context, "577224009303202_577224112636525");
