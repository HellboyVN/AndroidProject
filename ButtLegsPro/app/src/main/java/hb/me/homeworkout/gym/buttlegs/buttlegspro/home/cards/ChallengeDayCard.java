...
import hb.me.homeworkout.gym.buttlegs.buttlegspro.home.SquareRelativeLayout;
...
public class ChallengeDayCard extends AbstractCard {
    ...
    public void bind(Object data) {
        ...
        if (challengeDay.isDisabled()) {
            ...
            this.title.setTextColor(ContextCompat.getColor(this.context, R.color.colorCircle30Disable));
