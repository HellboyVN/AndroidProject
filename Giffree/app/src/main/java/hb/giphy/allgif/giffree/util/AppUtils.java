...
public class AppUtils {
    private final static String TRENDING_LINK_RIFFSY = "http://api.riffsy.com/v1/trending?key=V9YJLK2MHM2P&limit=50";
    private final static String MORE_TRENDING_LINK_RIFFSY = "http://api.riffsy.com/v1/trending?key=V9YJLK2MHM2P&pos=%s&limit=50";
    private final static String FIRST_LINK_RIFFSY = "http://api.riffsy.com/v1/search?key=V9YJLK2MHM2P&limit=50&tag=%s";
    private final static String LOAD_MORE_LINK_RIFFSY = "http://api.riffsy.com/v1/search?key=V9YJLK2MHM2P&pos=%s&limit=50&tag=%s";
