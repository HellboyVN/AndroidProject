...
public class NewyearFragment extends Fragment implements RiffsyPresenter.IPageView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            mPresenter = new RiffsyPresenter(this, this.getActivity(),mQuery);
            loadRiffsy();
        } catch (Exception e) {
            e.printStackTrace();
        }
