...
public class MainAdapter extends ArrayAdapter<JSONObject> implements KEYConstants {
    ...
    public MainAdapter(Context context, int resource, ArrayList<JSONObject> jsonObjects) {
                ...
                holder.favoriteButton.setOnClickListener(new OnClickListener() {
                    public void onClick(View view) {
                        try {
                            ...
                            if (DatabaseIO.database(mContext).updateFavorite(jsonObject.getInt("id"), favorite, tableIndex) != -1) {
