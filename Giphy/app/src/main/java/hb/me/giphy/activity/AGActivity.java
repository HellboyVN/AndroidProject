...
import hb.me.giphy.fragment.AboutFragment;
import hb.me.giphy.fragment.ExploreFragment;
import hb.me.giphy.fragment.FavoriteFragment;
import hb.me.giphy.fragment.SettingsFragment;
import hb.me.giphy.fragment.TrendingFragment;
import hb.me.giphy.fragment.VarietyFragment;
...
public class AGActivity extends AppCompatActivity implements FolderCallback ,BillingProcessor.IBillingHandler{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawer = new DrawerBuilder().withActivity(this).withToolbar(toolbar)
                ...
                .addDrawerItems(
//                        new PrimaryDrawerItem().withName(getString(R.string.sec_christmas))
...
//                                .withIdentifier(AppConstant.ID_NEWYEAR_ITEM),
                        ...
                        new PrimaryDrawerItem().withName(getString(R.string.sec_app_rocket))
                                .withTextColor(getResources().getColor(R.color.color_rocket))
                                .withSelectedTextColor(getResources().getColor(R.color.color_rocket))
                                .withIcon(R.drawable.ic_app_rocket).withIdentifier(AppConstant.ID_APP_ROCKET),
                        new PrimaryDrawerItem().withName(getString(R.string.sec_removeads))
                                .withTextColor(getResources().getColor(R.color.color_removeads))
                                .withSelectedTextColor(getResources().getColor(R.color.color_removeads))
                                .withIcon(R.drawable.ic_removeads).withIdentifier(AppConstant.ID_REMOVEADS)
...
//                                    AGActivity.this.switchFragment(AppConstant.ID_CHRISTMAS_ITEM, AGActivity.this.getString(R.string.sec_christmas));
//                                    break;
...
//                                    break;
                                ...
                                case AppConstant.ID_APP_IELTS:
                                    ...
                                    break;
                                case AppConstant.ID_APP_ROCKET:
                                    try {
                                    ...
                                    break;
                                case AppConstant.ID_REMOVEADS:
                                    try {
                                        if (AppConstant.isRemoveAds(getApplicationContext())) {
                                            Toast.makeText(AGActivity.this, "Ads are already removed!", Toast.LENGTH_SHORT).show();
                                            return true;
                                        }
                                        bp.purchase(AGActivity.this, "caotramanh");
                                        return true;
                                    } catch (ActivityNotFoundException e3) {
                                        Toast.makeText(AGActivity.this, getResources().getString(R.string.market_error), Toast.LENGTH_SHORT).show();
                                    }
...
//                    break;
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (!TextUtils.isEmpty(newText.trim())) {
                    String url = "https://api.tenor.com/v1/search_suggestions?tag=" + newText.trim() + "&key=ZRB4H2156Q76&limit=10";
    ...
    void initAdmob() {
        ...
        admob.facebookBaner(findViewById(R.id.ad_linear));
    ...
    void showFAd() {
        if(!AppConstant.isRemoveAds(getApplicationContext())) {
            interstitialAd = new InterstitialAd(this, "126646304687890_126828298003024");
    ...
    public void printHashKey() {
        try {
            PackageInfo info = getPackageManager().getPackageInfo("hb.me.giphy", PackageManager.GET_SIGNATURES);
