...
import hb.me.giphy.fragment.CategoryFragment;
...
public class CategoryActivity extends AppCompatActivity {
    ...
    void initAdmob() {
        ...
        admob.facebookBaner((LinearLayout) findViewById(R.id.ad_linear));
        showFAd();
    }
    void showFAd() {
        if(!AppConstant.isRemoveAds(getApplicationContext())) {
            interstitialAd = new InterstitialAd(this, "126646304687890_129615851057602");
