...
//        }
    ...
    public static boolean isAdsFreeVersion() {
        return  ((Boolean) getContentFromSharedPreferences(AppConstants.KEY_PREF_ADS_FREE_VERSION, Boolean.class)).booleanValue() ;
    }
    ...
    public static boolean isPremiumVersion() {
        return  true;//((Boolean) getContentFromSharedPreferences(AppConstants.KEY_PREF_PREMIUM_VERSION, Boolean.class)).booleanValue();
    }
