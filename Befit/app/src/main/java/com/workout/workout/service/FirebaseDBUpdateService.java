...
import com.workout.workout.modal.AppSettings;
...
public class FirebaseDBUpdateService extends Service {
    ...
    private void saveAppSettings(AppSettings appSettings) {
        ...
        try {
            planWorkoutListNativeAdInterval = Integer.parseInt(appSettings.getPlan_workout_list_native_ads_repeat_interval());
