...
import com.workout.workout.adapter.AddWorkoutToPlanBodyPartSpinnerAdapter;
import com.workout.workout.adapter.AddWorkoutToPlanExerciseSpinnerAdapter;
...
public class AddWorkoutToPlanActivity extends BaseActivity {
    ...
    private void prepareAndSetupDaySpinner() {
        ...
        dayList.add("Sunday");
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter(this, 17367048, dayList);
    ...
    private void prepareAndSetupPlanSpinner() {
        ...
        ArrayAdapter<Plan> arrayAdapter = new ArrayAdapter(this, 17367048, this.planList);
        arrayAdapter.setDropDownViewResource(17367049);
